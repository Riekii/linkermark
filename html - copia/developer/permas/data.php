    ...
    <body id="body" style="background-image:none;" class="bg-white">
        <?php include "../permas/top.php"?>
            ...
            <div class="cabecera" style="background-color:aliceblue">
                <?php
                if ($color == "black") {
                    echo '<img class="shadow p-3 mb-5 bg-white rounded" src="../img/logoo.png" height="150px" style="background-color:white;">';
                }
                else{
                echo '<img class="shadow p-3 mb-5 bg-white rounded" src="../img/logoo.png" height="150px" style="background-color:'.$color.'">';
                }
                ?>
            </div>
    <!-- Fin logo -->
